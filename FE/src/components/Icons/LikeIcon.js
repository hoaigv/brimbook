export const LikeIcon = ({ width = "18px", height = "18px", className }) => (
  <svg
    className={className}
    width={width}
    height={height}
  ...
  >
    <path
      ...
      strokeLinecap="round"
    ></path>
    <path d="M7 20L7 9" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"></path>
  </svg>
);
