  ...
  return (
    <div className={cx('wrapper')}>
      ...
      <div className={cx('inner')}>
        ...
        <Image className={cx('avatar')} src={'https://taoanhdep.com/wp-content/uploads/2023/12/hinhnen-khoa-hoc.jpg'} />
        ...
        <form className={cx('form')}>
          <div className={cx('form-group')}>
            ...
            <input className={cx('input')} type="text" placeholder={name} onChange={(e) => setName(e.target.value)} />
          </div>
          <div className={cx('form-group')}>
          ...
          <div className={cx('form-group')}>
            ...
            <input type="text" placeholder={phone} className={cx('input')} onChange={(e) => setPhone(e.target.value)} />
          </div>
