        ...
        return CompletableFuture.runAsync(
                () -> {
                    ...
                    books.forEach(book -> {
                        ...
                        Map<Integer, Object> data = comments.stream().collect(Collectors.toMap(
                                BaseEntity::getId, CommentEntity::getContentComment
                        ));
                        HttpEntity<Map<Integer, Object>> entity = new HttpEntity<>(data, headers);
