...
public class ChapterController {
    ...
    public ApiResponse<ChapterReadResponse> getChapterById(@PathVariable int chapterId) {
    ...
    public ApiResponse<ChapterUpdateResponse>  updateChapter(@PathVariable int chapterId , @RequestBody ChapterUpdateRequest request) {
