...
public class UserController {
    ...
    @PutMapping
    public ApiResponse<UserResponse> updateUser(@RequestBody  List<String> roles , @RequestBody Integer userId){
      var resp = userService.updateRoleUser(roles,userId);
      return ApiResponse.<UserResponse>builder().result(resp).build();
    }

    @DeleteMapping
    public ApiResponse<Void> deleteUser(@RequestBody Set<Integer> userId) {
